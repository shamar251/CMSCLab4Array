...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
	...
	System.out.println("_____PrintArray_____");
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	System.out.println("_________Set Value_________ for row " + row + " with value= " + value);
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   System.out.println("Find the Minimum from the column =" + column);

	int minimum = Integer.MAX_VALUE;// start with some max value
	  for (int i = 0; i < intArray.length; i++) {
		  if (minimum > intArray[i][column]) {
			  minimum = intArray[i][column];// change the min value to the current value
		  }
		  animate(i, column, minimum); // animate the output
	  	  }
	   		System.out.println("Minimum of in column " + column + " = " + minimum);
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	System.out.println("________Count Frequency of = " + value + " in the matrix.");
